...
<?php
					if(!isset($this->variables['pages']))
					{
						...
						$this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['fail'] = true;
					}
				if(isset(${'pages'})) $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['old'] = ${'pages'};
				$this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['iteration'] = $this->variables['pages'];
				$this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['i'] = 1;
				$this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['count'] = count($this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['iteration']);
				foreach((array) $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['iteration'] as ${'pages'})
				{
					if(!isset(${'pages'}['first']) && $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['i'] == 1) ${'pages'}['first'] = true;
					if(!isset(${'pages'}['last']) && $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['i'] == $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['count']) ${'pages'}['last'] = true;
	...
	<?php
					if(isset(${'pages'}['noPage']) && count(${'pages'}['noPage']) != 0 && ${'pages'}['noPage'] != '' && ${'pages'}['noPage'] !== false)
					{
						?>&hellip;<?php } ?>
<?php
					$this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['fail']) && $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:pages}<?php
					}
				if(isset($this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['old'])) ${'pages'} = $this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']['old'];
				else unset($this->iterations['8d6632605d51dec700abad2e99de760e_paging.tpl.php_1']);
				?>
