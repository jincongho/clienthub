...
<?php
				...
				if($this->getForceCompile()) $this->compile('E:\xampp\htdocs\clientManager_new\cm_includes\templates', $include);
				$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'E:\xampp\htdocs\clientManager_new\cm_includes\templates');
				if($return === false && $this->compile('E:\xampp\htdocs\clientManager_new\cm_includes\templates', $include))
				{
					$return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, 'E:\xampp\htdocs\clientManager_new\cm_includes\templates');
				}
?>
